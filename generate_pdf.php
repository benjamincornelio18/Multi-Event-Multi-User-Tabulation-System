...
<img class="caring" src="data:image/jpeg;base64,' . base64_encode(file_get_contents('img/caring.png')) . '" alt="HELLO WORLD">
        <header style="line-height: 0.2; margin-bottom: 10px;">
            ...
            <h4 >Dinge Campus</h4>
            <h4 style="text-lign:center;margin-bottom:20px;">CULTURE AND THE ARTS FESTIVAL 2024</h4>  January 8-12, 2024
        </header>
...
$html .= '<th><p style="font-size:10px">Combined</p> <p style="font-size:10px">Rank</p></th></tr></thead>
      ...
      <h5 style="text-align:left;margin-bottom:-25px">ELAINE ANZURES,PhD</h5>
      <h6 style="text-align:left;"> Professor, College of Education</h6>
