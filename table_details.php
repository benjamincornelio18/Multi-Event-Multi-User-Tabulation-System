       ...
       <div class="modal-dialog" role="document">
           <div class="modal-content">
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<input type='text' class='form-control' name='tableName' id='tableName' value='$tableName'>";
             ...
             <div class="modal-dialog" role="document">
                 <div class="modal-content">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<input class="form-check-input" type="checkbox" name="selected_emails[]" value="'. $email .' " >';
                        echo '<label class="form-check-label">' . $email . '    ('. $firstname .' '. $lastname .')</label>';
                        echo "<input type='text' class='form-control' name='tableName' id='tableName' value='$tableName'required>";
