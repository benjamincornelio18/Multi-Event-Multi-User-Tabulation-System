...
try {
        ...
        if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              $lastname= $row['lastname'];
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = '1st University Week Celebration, Literary, Musical Contests and Arts festival 2024: Thank You for Your Judging Expertise';
                    ...
                    $mail->Body    .= '<p>We would like to extend our heartfelt thanks for your role as a judge in our Literary, Musical Contests and Arts festival 2024.</p>';
                    ...
                    $mail->Body    .= '<p>Attached in this email is your digital copy of your <b>Certificate of Appearance.</b></p>';
                    ...
                    $mail->Body    .= '<p>From our University President, <b> DR. NORDY D. SIASON JR. CESO VI </b> and our Campus Administrator, <b>Engr. REX D. DIAZ, DIT </b></p>';
    ...
    // Function to generate PDF content using Dompdf CERT OF APPEARANCE
    function generatePDFContent2($tablename,$selectedEmails) {
        try {
          ...
          echo "Formatted date is: $formattedDate";
            ...
            $bgImageStyle = 'url(\'data:image/jpeg;base64,' . base64_encode(file_get_contents('img/appearance.png')) . '\')';
            $html = '
            <html>
            <head>
                <style>
            ...
            <body>
            <p style="line-height: 1; font-family:century; text-align: center; font-size: 50px; margin-bottom:25px; margin-top: 260px;margin-left: -30px;">' . $firstname .' '. $lastname . ' </p>';
